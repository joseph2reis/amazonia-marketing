...
export default function ProductForm({
  ...
  return (
    ...
    `}
        ...
        {uploading && (
          <div className="w-full bg-surface border rounded h-3 mt-2">
            <div
          ...
          <div className="flex gap-5">
            {images.map((url) => (
              <div
                ...
                key={url}
                className={`relative rounded-lg border p-4 w-32 ${
              ...
              >
                ...
                {mainImage === url ? (
                  <p className="text-xs">imagem principal</p>
                ) : (
                  ""
                )}
                  ...
                  <button
                    ...
                    onClick={() => {
                      setImages((prev) => {
                        ...
                        setMainImage(filtered.length ? filtered[0] : null);
                        return filtered;
                      });
                    }}
                    className="rounded bg-white/80 px-2 text-xs text-red-600"
                  >
                    ✕
                  </button>
                </div>
      ...
      <div className="flex justify-end gap-2 pt-4">
        <button
          type="button"
          onClick={onCancel}
          className="rounded-xl border border-border px-4 py-2 text-text-muted hover:bg-surface-strong"
        >
          Cancelar
        </button>
